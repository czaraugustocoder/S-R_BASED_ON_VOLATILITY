...
print(ticker1)
df1 = yf.download(ticker1, "2012-01-01", str(str(datetime.today().year)+"-"+str(datetime.today().day)+"-"+str(datetime.today().month)))
...
fig.update_layout(height = 600, width = 800
                , title_text = "Monthly S&D Volatility Zones: " + ticker1
                , font_color = "blue"
